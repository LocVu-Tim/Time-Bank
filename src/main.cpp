...
int main()
{
    ...
    {
        User *admin1 = new (std::nothrow) User(1, "admin1", "password1", "John Doe", "john@example.com", "123 Main St",  "0123456789",false, {}, 20, 2, 0, 0 ,0, {});
        User *admin2 = new (std::nothrow) User(2, "admin2", "password2", "Jane Doe", "jane@example.com", "456 Oak St", "0213645987",false, {}, 20, 2, 0, 0 ,0, {});
        User *user1 = new (std::nothrow) User(3, "user1", "password3", "Bob Doe", "bob@example.com", "234 Wall St", "0345671298",false, {}, 20, 2, 0, 0 ,0, {});
        User *user2 = new (std::nothrow) User(4, "user2", "password4", "Bob Smith", "smith@example.com", "234 Oak St", "0498765298",false, {}, 20, 2, 0, 0 ,0, {});
        User *user3 = new (std::nothrow) User(5, "user3", "password5", "John Smith", "jsmtih@example.com", "456 Main St", "0512345678",false, {}, 20, 2, 0, 0 ,0, {});
        User *user4 = new (std::nothrow) User(6, "user4", "password6", "Bob Dover", "dover@example.com", "789 Greens St", "0648395023",false, {}, 20, 2, 0, 0 ,0, {});
        User *user5 = new (std::nothrow) User(7, "user5", "password7", "Peter Smith", "peter@example.com", "123 Greens St", "0712312345",false, {}, 20, 2, 0, 0 ,0, {});
        User *user6 = new (std::nothrow) User(8, "user6", "password8", "Peter Parker", "parker@example.com", "345 Brooklyn St", "0898745631",false, {}, 20, 2, 0, 0 ,0, {});
        User *user7 = new (std::nothrow) User(9, "user7", "password9", "Harry Bon", "bon@example.com", "123 Oak St", "0923784590",false, {}, 20, 2, 0, 0 ,0, {});
        User *user8 = new (std::nothrow) User(10, "popo", "12313","Boby Spark", "sth@gmail.com", "752 Sth Street", "9812411",
                                              false, {}, 20, 2, 0, 0 ,0, {});
